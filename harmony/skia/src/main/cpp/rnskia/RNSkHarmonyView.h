...
public:
    virtual void surfaceAvailable(OHNativeWindow *surface, int width, int height, bool isP3ColorSpace) = 0;
...
public:
    ...
    void surfaceAvailable(OHNativeWindow *surface, int width, int height, bool isP3ColorSpace) override {
        std::static_pointer_cast<RNSkOpenGLCanvasProvider>(T::getCanvasProvider())
            ->surfaceAvailable(surface, width, height, isP3ColorSpace);
